export default function Hero() {
  return (
    <section
      id="inicio"
      className="relative flex min-h-[85vh] flex-col items-center overflow-hidden bg-stone px-6 pb-20 pt-10 text-center md:min-h-screen md:justify-center md:px-10 md:pb-0 md:pt-20"
    >
      <div
